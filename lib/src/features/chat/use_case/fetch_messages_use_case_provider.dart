...
import 'package:riverpod_chat/src/features/chat/use_case/fetch_messages_use_case.dart';
import 'package:riverpod_chat/src/features/profile/data/profile_repository_provider.dart';

part 'fetch_messages_use_case_provider.g.dart';

@Riverpod(keepAlive: true)
FetchMessagesUseCase fetchMessagesUseCase(Ref ref) {
